        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-3 space-y-8">
                ...
                <div class="flex gap-4 border-b border-slate-200 pb-1 overflow-x-auto">
                    ...
                    <a href="{{ route('instructor.dashboard.calendar') }}" class="bg-[#1a3652] text-white px-5 py-2.5 rounded-xl text-xs font-bold flex items-center gap-2 whitespace-nowrap shadow-md">
