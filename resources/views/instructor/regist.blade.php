    ...
    <div class="flex flex-col lg:flex-row min-h-screen w-full">
        ...
        <div class="hidden lg:flex lg:w-[40%] bg-[#1a3652] text-white p-12 flex-col justify-between relative min-h-screen">
            ...
            <div class="relative z-10">
                ...
                <h1 class="text-4xl font-bold mb-6 leading-tight">
                    Mulai Perjalanan <br> Mengajarmu Hari Ini
                </h1>
                <p class="text-slate-400 mb-12 max-w-sm leading-relaxed text-sm">
                    Bergabung dengan ribuan pengajar yang sudah menemukan cara mengajar yang efisien dan menyenangkan bersama AjarIn.
                </p>
                ...
                <ul class="space-y-6">
                    <li class="flex items-center gap-4 text-slate-300">
                        ...
                        <span class="text-sm">Buat kursus dan bagikan pengetahuanmu</span>
                    </li>
                    <li class="flex items-center gap-4 text-slate-300">
                        <div class="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center text-[10px]">
        ...
        <div class="w-full lg:w-[60%] p-8 md:p-16 bg-white">
            <div class="max-w-xl mx-auto">
                <a href="{{ route('instructor.login') }}" class="inline-flex items-center text-slate-500 text-xs font-medium mb-10 hover:text-slate-800 transition-colors">
                ...
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <span class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Pendaftaran Pengajar</span>
                </div>

                <h2 class="text-3xl font-extrabold text-[#1a3652] mb-2 tracking-tight">Buat Akun Pengajar</h2>
                <p class="text-slate-500 text-sm mb-12">Isi data di bawah ini untuk membuat akun pengajarmu.</p>

                <form action="{{ route('instructor.register.submit') }}" method="POST" enctype="multipart/form-data" class="space-y-10">
                    @csrf
                    ...
                    <div class="pt-6">
                        ...
                        <p class="text-center text-xs text-slate-500 mt-10">
                            Sudah punya akun? <a href="{{ route('instructor.login') }}" class="text-[#1a3652] font-black hover:underline">Masuk di sini</a>
                        </p>
                    </div>
                </form>
            </div>
