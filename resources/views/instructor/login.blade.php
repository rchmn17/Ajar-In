        ...
        <div class="w-full lg:w-7/12 flex items-center justify-center p-6 md:p-12">
            <div class="max-w-md w-full">
                ...
                <div class="flex p-1.5 bg-slate-100 rounded-2xl mb-6">
                    <a href="{{ route('student.login') }}" class="flex-1 py-2.5 text-xs font-bold text-slate-400 rounded-xl flex items-center justify-center gap-2 hover:text-slate-600 transition" wire:navigate>
                        <i class="fas fa-book-open"></i> Pelajar
                    </a>
                    <a href="{{ route('instructor.login') }}" class="flex-1 py-2.5 text-xs font-bold bg-white text-slate-900 rounded-xl shadow-sm border border-slate-200 flex items-center justify-center gap-2" wire:navigate>
                ...
                <div class="mt-12 p-6 bg-slate-50 border border-slate-100 rounded-[2rem]">
                    <p class="text-[10px] font-black text-slate-400 tracking-widest uppercase mb-4 text-center">Akun Demo — Coba Langsung</p>
                    <div class="grid grid-cols-2 gap-4">
                        <div class="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm">
                            <p class="text-[11px] font-bold text-slate-900 mb-0.5">Demo Pelajar</p>
                            <p class="text-[9px] text-slate-400 font-medium">learner@ajarin.id</p>
                        </div>
                        <div class="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm">
                            <p class="text-[11px] font-bold text-slate-900 mb-0.5">Demo Pengajar</p>
                            <p class="text-[9px] text-slate-400 font-medium">tutor@ajarin.id</p>
                        </div>
                    </div>
                </div>
