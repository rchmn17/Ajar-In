    ...
    <main class="max-w-7xl mx-auto px-8 py-10">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-4">
            <div>
                ...
                <h1 class="text-3xl font-bold text-[#1a3652]">Selamat datang, {{ Auth::user()->name ?? 'Rizky' }}! 👋</h1>
            </div>
            <div class="flex items-center gap-3">
                <a href="{{ route('student.monitoring') }}" class="px-6 py-2.5 bg-white border border-slate-200 rounded-xl text-sm font-bold text-slate-600 hover:bg-slate-50 transition-all">
            ...
            <div class="lg:col-span-8 space-y-8">
                ...
                <div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-8">
                    <div class="flex items-center justify-between mb-8">
                        ...
                        <a href="{{ route('student.search') }}" class="text-xs font-bold text-[#1a3652] hover:underline flex items-center gap-2">
                            ...
                            <div class="group flex items-center justify-between p-4 rounded-[1.5rem] border border-transparent hover:border-slate-100 hover:bg-slate-50/50 transition-all">
                                <div class="flex items-center gap-4">
                                    <div class="w-12 h-12 rounded-xl bg-slate-100 overflow-hidden">
                                        <img src="https://ui-avatars.com/api/?name={{ urlencode($s['tutor']) }}&background=random" alt="Avatar" class="w-full h-full">
                                    </div>
                                    <div>
                ...
                <div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-8">
                    ...
                    <div class="space-y-6">
                        <div class="relative pl-4 border-l-2 border-emerald-500">
                            ...
                            <p class="text-[10px] text-slate-400 leading-relaxed mb-1">Pemahaman konsep DataFrame sangat baik. Perlu latihan lebih pada operasi merge.</p>
